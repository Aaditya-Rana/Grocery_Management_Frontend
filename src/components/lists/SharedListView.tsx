...
import type { GroceryList, ListItem, ShareData, ItemStatus, KanbanItem, KanbanStatus } from '../../types';
                ...
                <div className="flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
                    <div>
                        ...
                        <p className="text-blue-100">
                            {doneCount}/{items.length} items done • Status: <span className="font-semibold capitalize">{list.status}</span>
                        </p>
                    </div>
                        ...
                        <div className="min-w-max grid grid-cols-5 gap-6 px-2">
                            {[
                                ...
                                <BoardColumn
                                    ...
                                    onMoveItem={(itemId, newStatus) => onUpdateItemStatus(itemId, newStatus as ItemStatus)}
                                    onDeleteItem={() => { /* shared view should not delete */ }}
                                />
                            ))}
                        </div>
                    </div>
